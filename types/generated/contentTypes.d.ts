...
export interface ApiPersonalInfoPersonalInfo extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Personal information displayed on the portfolio';
  ...
  attributes: {
    ...
    heroCtaText: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Hire me'>;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Services/specializations offered';
    displayName: 'Service';
    pluralName: 'services';
...
export interface ApiSkillSkill extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['frontend', 'backend', 'mobile', 'database', 'devops', 'other']
    > &
